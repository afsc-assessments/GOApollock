...
trawl survey. Similar to 2021 these showed similar trends, unlike
previous years when the surveys showed strongly contrasting
trends. The risk matrix table recommended by the SSC was used to
determine whether to recommend an ABC lower than the maximum
permissible. The table is applied by evaluating the severity of
four types of considerations that could be used to support a
scientific recommendation to reduce the ABC from the maximum
...
from the `r year` ABC. The author’s recommended `r year+2` ABC
