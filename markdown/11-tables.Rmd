...
tab <- data.frame(age=c(1:9, "10+"), a=repfile_admb$Natural_mortality, 
      b=repfile_admb$Projection_fishery_selectivity,
      c=repfile_admb$Projection_spawning_weight_at_age,
      d=repfile_admb$Projection_population_weight_at_age,
