...
> The SSC in December 2020: "For the ESP socioeconomic indices, the SSC suggests using Kodiak and small community categories for the annual percent harvesting revenue indicators similar to what was done for the annual percent processing revenue indicators, for consistency with the text in this ESP (pg. 110) and the approach used in other ESPs, as well as for comprehensiveness"

In the future, we plan to conduct a thorough evaluation of the information provided in the Economic SAFE and ACEPO report to determine what socioeconomic indicators could be provided in the ESP that are not redundant with those reports and related directly to stock health. This may result in a transition of indicators currently reported in this ESP to a different series of socioeconomic indicators in future ESPs and may include aggregating small communities as suggested or focusing more on dependency rather than engagement. Additional considerations should be given for the timing of the economic and community reports that are delayed by 1-2 years depending on the data source from the annual stock assessment cycle and how this information might inform the stock assessment
