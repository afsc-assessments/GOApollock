...
[@trijoulet2023a] was implemented. The residuals did not show the
same pattern, implying it was a consequence of the inadequateness
of Pearson residuals and not a real misspecification of
selectivity. These new residuals will be explored in the coming
year. 
...
tables (steps 5 and 6) together, and simplifying some of the
tables. Note that this new structure was not supposed to change
...
availability. Prelminary results are very promising and we
