...
allozyme frequencies (Grant and Utter 1980), mtDNA variability
[@mulligan1992a], and microsatellite allele variability (Bailey
et al. 1997). See figure \@ref(fig:fig1) and table
\@ref(tab:tab1).
...
(Olsen et al. 2002). However, significant variation in allozyme
...
this spawning population. Olsen et al. (2002) suggest that
interannual genetic variation may be due to variable reproductive
success, adult philopatry, source-sink population structure, or
...
group was provided as an appendix to the 2012 assessment (Dorn et
al., 2012). Available information supported the current approach
